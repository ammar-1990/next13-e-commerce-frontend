...
addItem(product)
  ...
  return (
    <div className={cn("border bg-white p-3 rounded-xl flex flex-col gap-y-4 group cursor-pointer relative w-[200px] md:w-[300px] flex-shrink-0 justify-self-center",filters && 'w-full md:w-full')}
